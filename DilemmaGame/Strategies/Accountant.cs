...
namespace DilemmaGame.Strategies
{
    class Accountant
    {
        ...
        {
            return "Вычисляет среднее значение получаемое от данного оппонента при сотрудничестве и предательстве и выбирает то, которое приносит в среднем больше  ";
        }
        public static bool Strategy(Game.GameInfo GameInfo, int MyNumber, int OpponentNumber)
        {
            ...
            return CoopsImpact >= BetraysImpact;
        }
    }
}
