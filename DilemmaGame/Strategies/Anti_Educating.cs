...
{
    class Anti_Educating
    {
        public static string Description()
        {
            return "первый ход сотрудничество, сотрудничает если оппонент отвечал сотрудничеством на предательство или предательством на сотрудничество в прошлом ходу  ";
        }
