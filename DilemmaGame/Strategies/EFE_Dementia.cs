...
namespace DilemmaGame.Strategies
{
    class EFE_Dementia
    {
        ...
        {
            return "первый ход сотрудничество, дальше повторение предыдущего хода опонента против себя, с высоким шансом не повторяет предательство";
        }
